...
class DiscordClient
{
	...
	private static final _defaultID:String = "1273740201080127650";
	...
	public static function changePresence(?details:String = 'In the Menus', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float, ?largeImageKey : String)
	{
		...
		{
			presence.largeImageKey = 'iconbase';
		}

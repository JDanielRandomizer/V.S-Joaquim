...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['V.S. Joaquim Team'],
			['NineFds',		'nine',		'animador, compositor, charter,\ndiretor e criador do personagem do mod',					 'https://www.youtube.com/@NineFds',		'CCD7E2'],
			['JDaniel Aleatorio',		'jdaniel',		'Artista e programador do mod',					 'https://www.youtube.com/@JDanielAleatorio',		'00AE27'],
			[''],
			['Psych Engine Team'],
